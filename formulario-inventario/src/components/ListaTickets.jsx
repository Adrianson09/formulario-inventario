...
const ListaTickets = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto bg-white p-6 shadow-md rounded-lg">
            <h1 className="text-xl font-bold mb-4">Listado de Tickets</h1>
            ...
            <table className="w-full border mt-2">
                <thead>
                    <tr className="bg-gray-200">
                        ...
                        <th className="border p-2">Ticket Venta</th>
                ...
                <tbody>
                    {filteredTickets.map(ticket => (
                        <tr key={ticket.id} className="hover:bg-gray-100 cursor-pointer">
                            ...
                            <td className="border p-2">{ticket.proyecto}</td>
                            <td className="border p-2">{ticket.ticket_venta}</td>
                            <td className="border p-2">{ticket.solicitante}</td>
